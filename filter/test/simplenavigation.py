...
class SimpleNavigationPlanning:
    ...
    def performNavigationPlanning(self, maxiter=5000, steplength=0.1, maxtries=2):
        ...
        while True:
            ...
            if self.basemanip.MoveActiveJoints(goal=goal,maxiter=maxiter,steplength=steplength, maxtries=maxtries) is None:
                print 'retrying'
                continue
            else:
                print "done"
